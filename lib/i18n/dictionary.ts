...
const en = {
  ...
  "swipe.pass": "Pass",
  "swipe.undo": "Undo",
  "swipe.undo_limit_heading": "Undo is a premium feature",
  "swipe.undo_limit_body": "Upgrade to premium to take back your last swipe.",
  ...
  "matches.expires_in": "Expires in {time}",
  "matches.expired_badge": "Expired",
  "matches.blocked_badge": "Blocked",
  "matches.ended_badge": "Ended",
  ...
  "matches.delete.heading": "Delete conversation?",
  "matches.delete.body": "It disappears for you only. The other person keeps their copy, and nothing is deleted for them.",
  "chat.conversation_ended": "This conversation has ended.",
  "chat.conversation_ended_sub": "You can still read the messages.",
  "chat.conversation_expired": "This match has expired.",
  "chat.conversation_expired_sub": "Matches expire 7 days after the chat opens.",
  ...
  "icebreaker.q.ideal_evening":     "What does your ideal evening at home look like?",
  ...
  "chat.block": "Block",
  "chat.block.heading": "Block this person?",
  "chat.block.body": "They will not be able to message you, and neither of you will show up in the other's deck again. Your conversation ends. This does not tell them they were blocked.",
  "chat.block.confirm": "Block",
  "chat.block.error": "Could not block this person. Try again.",
  "chat.conversation_blocked": "You blocked this person.",
  "chat.conversation_blocked_sub": "You can still read the messages. Unblock them in Settings.",
  "chat.send_blocked": "This message could not be sent.",
  "settings.blocked_users": "Blocked people",
  "settings.blocked_users_sub": "People you blocked can never message you or appear in your deck.",
  "settings.blocked_empty": "You have not blocked anyone.",
  "settings.blocked_unblock": "Unblock",
  "settings.blocked_unknown": "Blocked person",
  "chat.report": "Report",
  ...
  "chat.report.reason_inappropriate": "Inappropriate advances",
  "chat.report.reason_harassment": "Harassment",
  "chat.report.reason_fake": "Fake profile",
  "chat.report.reason_other": "Other",
  "chat.report.reason_contact_sharing": "Sharing contact details",
  "chat.report.reason_threat": "Threatening or unsafe",
  "chat.report.message_heading": "Report this message",
  "chat.report.report_message": "Report message",
  "chat.voice.locked": "Voice messages unlock once you have each sent {n} messages.",
  "chat.voice.record": "Hold to record",
  "chat.voice.recording": "Recording…",
  "chat.voice.too_long": "Voice messages can be up to 60 seconds.",
  "chat.voice.send_failed": "The voice message could not be sent.",
  "chat.voice.permission": "Microphone access is needed to record a voice message.",
  "chat.voice.play_failed": "This recording could not be played.",
...
const cs: Record<string, string> = {
  ...
  "swipe.undo": "Zpět",
  "swipe.undo_limit_heading": "Vrácení swipe je prémiová funkce",
  "swipe.undo_limit_body": "Upgraduj na premium, abys mohl vrátit poslední swipe.",
  ...
  "matches.expires_in": "Vyprší za {time}",
  "matches.expired_badge": "Vypršelo",
  "matches.blocked_badge": "Zablokováno",
  "matches.ended_badge": "Skončilo",
  ...
  "matches.delete.heading": "Smazat konverzaci?",
  "matches.delete.body": "Zmizí jenom tobě. Druhá strana si svoji kopii ponechá a nic se jí nesmaže.",
  "chat.conversation_ended": "Tato konverzace skončila.",
  "chat.conversation_ended_sub": "Zprávy si stále můžeš přečíst.",
  "chat.conversation_expired": "Tento match vypršel.",
  "chat.conversation_expired_sub": "Shody vyprší 7 dní po otevření chatu.",

  // ---------- icebreakers (gendered .m / .f; EN falls back to base key) ----------
  "icebreaker.q.recharge.m":           "Kam zajdeš, když potřebuješ dobít baterky?",
  "icebreaker.q.recharge.f":           "Kam zajdeš, když potřebuješ dobít baterky?",
  "icebreaker.q.last_book.m":          "Jaká je poslední kniha, u které ses nemohl odtrhnout?",
  "icebreaker.q.last_book.f":          "Jaká je poslední kniha, u které ses nemohla odtrhnout?",
  "icebreaker.q.ideal_evening.m":      "Jak vypadá tvůj ideální večer doma?",
  "icebreaker.q.ideal_evening.f":      "Jak vypadá tvůj ideální večer doma?",
  "icebreaker.q.interesting_person.m": "Kdo je nejzajímavější člověk, kterého jsi nedávno potkal?",
  "icebreaker.q.interesting_person.f": "Kdo je nejzajímavější člověk, kterého jsi nedávno potkala?",
  "icebreaker.q.best_night_out.m":     "Jaká byla tvá nejlepší noc venku letos?",
  "icebreaker.q.best_night_out.f":     "Jaká byla tvá nejlepší noc venku letos?",
  "icebreaker.q.spontaneous_thing.m":  "Co nejspontánnějšího jsi nedávno udělal?",
  "icebreaker.q.spontaneous_thing.f":  "Co nejspontánnějšího jsi nedávno udělala?",
  "icebreaker.q.packed_and_left.m":    "Sbalil ses někdy jen tak a odjel někam bez plánu?",
  "icebreaker.q.packed_and_left.f":    "Sbalila ses někdy jen tak a odjela někam bez plánu?",
  "icebreaker.q.looking_forward.m":    "Na co se teď hodně těšíš?",
  "icebreaker.q.looking_forward.f":    "Na co se teď hodně těšíš?",
  "icebreaker.q.five_years.m":         "Kde chceš být za pět let — upřímně?",
  "icebreaker.q.five_years.f":         "Kde chceš být za pět let — upřímně?",
  "icebreaker.q.overthought.m":        "Co jsi nedávno přemýšlel k smrti?",
  "icebreaker.q.overthought.f":        "Co jsi nedávno přemýšlela k smrti?",
  "icebreaker.q.moved_you.m":          "Co tě naposledy opravdu dojalo?",
  "icebreaker.q.moved_you.f":          "Co tě naposledy opravdu dojalo?",
  "icebreaker.q.crier_films.m":        "Brečíš u filmů?",
  "icebreaker.q.crier_films.f":        "Brečíš u filmů?",
  "icebreaker.q.peaceful_day.m":       "Jak pro tebe vypadá opravdu klidný den?",
  "icebreaker.q.peaceful_day.f":       "Jak pro tebe vypadá opravdu klidný den?",
  "icebreaker.q.wind_down.m":          "Jak se dostaneš z těžkého týdne?",
  "icebreaker.q.wind_down.f":          "Jak se dostaneš z těžkého týdne?",
  "icebreaker.q.talk_for_hours.m":     "O čem bys mohl mluvit hodiny?",
  "icebreaker.q.talk_for_hours.f":     "O čem bys mohla mluvit hodiny?",
  "icebreaker.q.cause_you_care.m":     "Je nějaká věc, na které ti skutečně záleží?",
  "icebreaker.q.cause_you_care.f":     "Je nějaká věc, na které ti skutečně záleží?",
  "icebreaker.q.free_weekend.m":       "Volný víkend, žádné plány — co se reálně stane?",
  "icebreaker.q.free_weekend.f":       "Volný víkend, žádné plány — co se reálně stane?",
  "icebreaker.q.working_toward.m":     "Na čem teď pracuješ nebo co buduješ?",
  "icebreaker.q.working_toward.f":     "Na čem teď pracuješ nebo co buduješ?",
  "icebreaker.q.best_trip.m":          "Jaký byl nejlepší výlet, který jsi kdy podnikl?",
  "icebreaker.q.best_trip.f":          "Jaký byl nejlepší výlet, který jsi kdy podnikla?",
  "icebreaker.q.chasing_next.m":       "Jaký zážitek teď honíš?",
  "icebreaker.q.chasing_next.f":       "Jaký zážitek teď honíš?",
  "icebreaker.q.place_like_home.m":    "Existuje místo, které ti vždy připadá jako domov?",
  "icebreaker.q.place_like_home.f":    "Existuje místo, které ti vždy připadá jako domov?",
  "icebreaker.q.doing_nothing.m":      "Jaký máš vztah s naprostým nicneděláním?",
  "icebreaker.q.doing_nothing.f":      "Jaký máš vztah s naprostým nicneděláním?",
  "icebreaker.q.productive_day.m":     "Jak vypadá opravdu produktivní den u tebe?",
  "icebreaker.q.productive_day.f":     "Jak vypadá opravdu produktivní den u tebe?",
  "icebreaker.q.prefer_alone.m":       "Co radši děláš sám?",
  "icebreaker.q.prefer_alone.f":       "Co radši děláš sama?",
  "icebreaker.q.love_with_people.m":   "Co rád děláš s ostatními?",
  "icebreaker.q.love_with_people.f":   "Co ráda děláš s ostatními?",
  "icebreaker.q.stay_home_evening.m":  "Jak vypadá tvůj perfektní večer doma?",
  "icebreaker.q.stay_home_evening.f":  "Jak vypadá tvůj perfektní večer doma?",
  "icebreaker.q.comfort_food.m":       "Co je tvoje comfort food?",
  "icebreaker.q.comfort_food.f":       "Co je tvoje comfort food?",
  "icebreaker.q.favourite_outside.m":  "Jaké je tvoje oblíbené místo venku?",
  "icebreaker.q.favourite_outside.f":  "Jaké je tvoje oblíbené místo venku?",
  "icebreaker.q.mountains_sea.m":      "Hory, moře, nebo les?",
  "icebreaker.q.mountains_sea.f":      "Hory, moře, nebo les?",
  "icebreaker.q.move_your_body.m":     "Jak se hýbeš?",
  "icebreaker.q.move_your_body.f":     "Jak se hýbeš?",
  "icebreaker.q.sport_defend.m":       "Je nějaký sport, který bys hájil za každou cenu?",
  "icebreaker.q.sport_defend.f":       "Je nějaký sport, který bys hájila za každou cenu?",
  "icebreaker.q.have_animals.m":       "Máš nějaká zvířata?",
  "icebreaker.q.have_animals.f":       "Máš nějaká zvířata?",
  "icebreaker.q.dog_cat_chaos.m":      "Psí typ, kočičí typ, nebo naprostý chaos?",
  "icebreaker.q.dog_cat_chaos.f":      "Psí typ, kočičí typ, nebo naprostý chaos?",
  "icebreaker.q.one_am.m":             "Co děláš ve jednu v noci, když nemůžeš spát?",
  "icebreaker.q.one_am.f":             "Co děláš ve jednu v noci, když nemůžeš spát?",
  "icebreaker.q.best_late.m":          "Co je nejlepší na tom být vzhůru pozdě?",
  "icebreaker.q.best_late.f":          "Co je nejlepší na tom být vzhůru pozdě?",
  "icebreaker.q.morning_looks_like.m": "Jsi ranní ptáče — jak tvoje ráno reálně vypadá?",
  "icebreaker.q.morning_looks_like.f": "Jsi ranní ptáče — jak tvoje ráno reálně vypadá?",
  "icebreaker.q.perfect_first_date.m": "Jak by vypadalo tvoje ideální první rande?",
  "icebreaker.q.perfect_first_date.f": "Jak by vypadalo tvoje ideální první rande?",
  "icebreaker.q.surprises_people.m":   "Co o sobě lidi překvapí, když tě lépe poznají?",
  "icebreaker.q.surprises_people.f":   "Co o sobě lidi překvapí, když tě lépe poznají?",
  "icebreaker.q.into_right_now.m":     "Do čeho jsi teď ponořený?",
  "icebreaker.q.into_right_now.f":     "Do čeho jsi teď ponořená?",
  "icebreaker.q.best_this_week.m":     "Co nejlepšího se ti stalo tento týden?",
  "icebreaker.q.best_this_week.f":     "Co nejlepšího se ti stalo tento týden?",
  "icebreaker.q.take_me_somewhere.m":  "Kdybychom šli někam spolu, kam bys mě vzal?",
  "icebreaker.q.take_me_somewhere.f":  "Kdybychom šli někam spolu, kam bys mě vzala?",
  "icebreaker.q.unpopular_opinion.m":  "Jaký máš skutečně nepopulární názor?",
  "icebreaker.q.unpopular_opinion.f":  "Jaký máš skutečně nepopulární názor?",
  ...
  "chat.block": "Zablokovat",
  "chat.block.heading": "Zablokovat tohoto člověka?",
  "chat.block.body": "Nebude ti moct psát a ani jeden z vás se tomu druhému už neukáže ve výběru. Vaše konverzace tím končí. Druhá strana se o zablokování nedozví.",
  "chat.block.confirm": "Zablokovat",
  "chat.block.error": "Zablokování se nepovedlo. Zkus to znovu.",
  "chat.conversation_blocked": "Tento člověk je zablokovaný.",
  "chat.conversation_blocked_sub": "Zprávy si stále můžeš přečíst. Odblokovat můžeš v Nastavení.",
  "chat.send_blocked": "Zprávu se nepodařilo odeslat.",
  "settings.blocked_users": "Zablokovaní lidé",
  "settings.blocked_users_sub": "Zablokovaní ti nikdy nemůžou napsat ani se ti zobrazit ve výběru.",
  "settings.blocked_empty": "Zatím tu nikdo zablokovaný není.",
  "settings.blocked_unblock": "Odblokovat",
  "settings.blocked_unknown": "Zablokovaný člověk",
  ...
  "chat.report.reason_inappropriate": "Nevhodné návrhy",
  "chat.report.reason_harassment": "Obtěžování",
  "chat.report.reason_fake": "Falešný profil",
  "chat.report.reason_other": "Jiné",
  "chat.report.reason_contact_sharing": "Sdílení kontaktu",
  "chat.report.reason_threat": "Ohrožení nebo výhrůžky",
  "chat.report.message_heading": "Nahlásit tuto zprávu",
  "chat.report.report_message": "Nahlásit zprávu",
  "chat.voice.locked": "Hlasové zprávy se odemknou, až si oba napíšete {n} zprávy.",
  "chat.voice.record": "Podrž pro nahrávání",
  "chat.voice.recording": "Nahrávám…",
  "chat.voice.too_long": "Hlasová zpráva může mít nejvýš 60 sekund.",
  "chat.voice.send_failed": "Hlasovou zprávu se nepodařilo odeslat.",
  "chat.voice.permission": "K nahrávání je potřeba přístup k mikrofonu.",
  "chat.voice.play_failed": "Nahrávku se nepodařilo přehrát.",
...
export function translate(
  ...
  // If the key ends in a gender suffix (.m / .f) and has no direct match,
  // also try the base key (without suffix) before giving up.
  const direct = dictionary[locale]?.[key];
  const fallback = dictionary.en[key];
  const baseKey = /\.[mf]$/.test(key) ? key.slice(0, -2) : null;
  const baseDirect  = baseKey ? dictionary[locale]?.[baseKey]  : undefined;
  const baseFallback = baseKey ? dictionary.en[baseKey] : undefined;
  let raw = direct ?? fallback ?? baseDirect ?? baseFallback ?? key;
