...
const en = {
  ...
  "landing.hero_heading": "Meet someone before you know who they are.",
  "landing.hero_sub": "A different kind of first impression.",
...
const cs: Record<keyof typeof en, string> = {
  ...
  "landing.hero_heading": "Poznej někoho, aniž víš, kdo to je.",
  "landing.hero_sub": "Jiný druh prvního dojmu.",
